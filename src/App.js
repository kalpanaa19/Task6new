      ...
      <div className="frame">
        ...
        <div className="body">
          <div className="about">
            ...
            <p>
              Hey! I am Kalpana Tolwani, 20 Years of age and currently pursuing
              my B.Tech Degree from VIT Bhopal in CSE-Core. I have been since
              the beginning of my time here on earth, fascinated by these
              machines
              <br />
